            ...
            <div class="row-fluid">
                        ...
                        <section>
                            ...
                            <ul>
                                ...
                                <li style="margin: 10px 0px">
                                    ...
                                    <a href="#" data-status="<?php echo $master[" tiene_hijos "] ?>" style="margin: 5px 6px" class="btn btn-warning btn-xs btn-folder">
                                    <span class='<?php echo $master['tiene_hijos'] == 1 ? 
                                        'glyphicon glyphicon-minus-sign' :
                                        'glyphicon glyphicon-plus-sign' ?>'
                                    </span> 
                                    <?php echo $master["nombre"] ?></a>
                                    <?php echo Tree::nested($childrens, $master[ "cedula"]) ?>
                                </li>
                                <?php } ?>
                            </ul>
                        </section>
                ...
                <div class="span4">
                    <div class="well">
                        ...
                        <div align="center">
                            <p><a href="lista_general.php" class=" btn btn-primary btn-lg pd4">Lista general</a>
                            </p>
